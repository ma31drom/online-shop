...
<link rel="stylesheet" href="/online-shop/css/jquery.mCustomScrollbar.min.css">
...
<body class="main-layout">
						...
						<div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
							<div class="full">
								<div class="center-desk">
									<div class="logo">
										<a href="index.html"><img src="/online-shop/images/logo.png" alt="#" /></a>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="collapse navbar-collapse" id="navbarsExample04">
									<ul class="navbar-nav mr-auto">
										...
										<c:if test="${sessionScope.user ne null}">
											<li class="nav-item">Hello ${sessionScope.user.login}!
											</li>
										</c:if>
										<c:if test="${sessionScope.user ne null}">
											<li class="nav-item"><a class="nav-link"
												href="/online-shop/logout">Logout</a>
											</li>
										</c:if>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="titlepage">
						<h2>
							About <span class="red"> Store</span>
						</h2>
					</div>
				</div>
			</div>
				...
				<div class="col-md-12">
					<div class="titlepage">
						...
						<span>It is a long established fact that a reader will be
							distracted by the readable content of a page when looking at its
							layout. The point of using Lorem</span>
					</div>
				</div>
			</div>
		</div>
						...
						<div class="row d_flex">
							<div class="col-md-3">
								<div class="Testimonial_box">
									<i><img src="/online-shop/images/plan1.png" alt="#" /></i>
								</div>
							</div>
							<div class="col-md-9">
								<div class="Testimonial_box">
			...
			<div class="row ">
				<div class="col-md-6 ">
					<div class="wines">
						...
						<p>It is a long established fact that a reader will be
							distracted by the readable content of a page when looking at its
							layout. The point of using Lorem ere, content here', making itIt
							is a long established fact that a reader will be distracted by
							the readable content of a page when looking at its layout. The
							point of using Lorem ere, content here', making it</p>
						<h3>
							Free Multipurpose <br> Responsive Landing Page 2019
						</h3>
					</div>
				</div>
				<div class="col-md-6 ">
					<form class="main_form ">
						<div class="row">
							...
							<div class="col-md-12">
								<input class="form_contril" placeholder="Phone Number"
									type="text" name=" Phone Number">
							</div>
							<div class="col-md-12">
								<input class="form_contril" placeholder="Email" type="text"
									name="Email">
							</div>
							<div class="col-md-12">
	...
	<!-- end Testimonial -->
	<!-- fileupload -->
	<div id="fileupload" class="talk">
		<div class="container">
			<div class="row ">
				<div class="col-md-6 ">
					<div class="wines">
						<h3>Lets upload file</h3>
						<p>Picture will go here
						<img alt="Image not found" src="/online-shop/sample-image">
					</div>
				</div>
				<div class="col-md-6 ">
					<form class="main_form " method="post" action="/online-shop/sample/upload" enctype="multipart/form-data">
						<div class="row">
							<div class="col-md-12 ">
								<input class="form_contril" type="file" name="file">
							</div>
							
							<div class="col-sm-12">
								<input class="send_btn" type="submit" value="Upload" />
							</div>
						</div>
					</form>
				</div>
	...
	<!-- end footer -->
	<!-- Javascript files-->
	<script src="/online-shop/js/jquery.min.js"></script>
	<script src="/online-shop/js/popper.min.js"></script>
	<script src="/online-shop/js/bootstrap.bundle.min.js"></script>
	<script src="/online-shop/js/jquery-3.0.0.min.js"></script>
	<script src="/online-shop/js/plugin.js"></script>
	<!-- sidebar -->
	<script src="/online-shop/js/jquery.mCustomScrollbar.concat.min.js"></script>
	<script src="/online-shop/js/custom.js"></script>
	<script
